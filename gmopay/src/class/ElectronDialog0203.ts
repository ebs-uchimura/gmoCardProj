...
class Dialog {
  ...
  showQuetion(title: string, message: string, detail: string): number {
    try {
      console.log("dialog: showQuetion started.");
      ...
      console.log("dialog: showQuetion finished.");
      // return selected
      return selected;
    } catch (e: unknown) {
      // error
  ...
  showImage(properties: any): any {
    try {
      console.log("dialog: showImage started.");
      // quetion message option
      ...
      console.log("dialog: showImage finished.");
      // return selected
      return result;
    } catch (e: unknown) {
      // error
  ...
  showmessage(type: string, message: string) {
    try {
      console.log("dialog: showmessage started.");
      // mode
      let tmpType:
        | "none"
        | "info"
      ...
      console.log("dialog: showmessage finished.");
    } catch (e: unknown) {
      // error
      if (e instanceof Error) {
        // error
